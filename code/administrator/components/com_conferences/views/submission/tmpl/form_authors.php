<? foreach(json_decode($submission->authors) as $author) : ?>
    ...
    <input class="" type="text" name="authors[0][organisation][0]" id="fld1" size="32" maxlength="255" placeholder="<?= @text('Organisation') ?>" value="<?= $author->organisation ?>" /><br />
...
<input class="" type="text" name="authors[0][organisation]" id="fld1" size="32" maxlength="255" placeholder="<?= @text('Organisation') ?>" value="" /><br />
